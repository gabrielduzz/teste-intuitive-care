...
Opção B: Execução Manual (Passo a Passo) 🛠️
...
# Nota: Este script tenta baixar dados da ANS. Se falhar (site offline),
# ele usará automaticamente os CSVs de backup na pasta /data/processed.
...
python import_data.py   # Carga no Banco (SQLAlchemy)
Inicie a API:
